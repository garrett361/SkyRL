AGENT_GENERATOR_REGISTRY = {
    ...
    "skyrl_agent.agents.react.OpenEnvReActAgent": "skyrl_agent.agents.base.AgentRunner",
}
...
AGENT_TRAJECTORY_REGISTRY = {
    ...
    "skyrl_agent.agents.react.OpenEnvReActAgent": "skyrl_agent.agents.react.openenv_react_runner.OpenEnvReActTrajectory",
}
